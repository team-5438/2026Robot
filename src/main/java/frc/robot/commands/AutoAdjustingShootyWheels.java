...
public class AutoAdjustingShootyWheels extends Command {
  ...
  public AutoAdjustingShootyWheels(ShootingSubsystem shootingSubsystem, SwerveSubsystem swerveSubsystem, SpencerAutoAim spencerAutoAim, double defaultSpeed) {
  ...
  public void initialize() {
    shootingSubsystem.shootWheelsRight.set(defaultSpeed); //NOT TESTED SPEED
    shootingSubsystem.shootWheelsLeft.set(-defaultSpeed); //NOT TESTED SPEED
  }
